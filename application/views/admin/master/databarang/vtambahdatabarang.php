	...
	<div class="row">
		<div class="col-lg-8">
			<div class="box box-default">
				...
				<form action="<?=site_url('admin/master/databarang/tambah_barang')?>" method="post" class="form-wajib">
					<div class="box-body">
							...
							<label>Kategori</label>
								<select name="id_kategori_barang" style="width: 100%" class="form-control select2">
									...
									<?php foreach ($kategori->result() as $key) { ?>
										<option value="<?=$key->id_kategori_barang?>"><?=$key->kategori?></option>
									<?php } ?>
								</select>
						</div>
							...
							<label>Merk</label>
								<select name="id_merk_barang" style="width: 100%" class="form-control select2">
									...
									<?php foreach ($merk->result() as $key) { ?>
										<option value="<?=$key->id_merk_barang?>"><?=$key->merk?></option>
									<?php } ?>
								</select>
						</div>
...
var url_2 = url_1.substring(0, url_1.lastIndexOf('/tambah_barang/'));
var fw = $('.form-wajib');
