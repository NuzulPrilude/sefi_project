	...
	<div class="row">
		<div class="col-lg-8">
			<div class="box box-default">
				...
				<form action="<?=site_url('admin/master/merk/editmerk/'.$id_merk_barang)?>" method="post" class="form-wajib">
					<div class="box-body">

						<div class="form-group">
							<label>Nama Merk</label>
							<div>
								<input type="text" class="form-control" value="<?=$data_merk->merk?>" name="merk" placeholder="Kategori">
							</div>
						</div>
...
var url_2 = url_1.substring(0, url_1.lastIndexOf('/editmerk/'));
var fw = $('.form-wajib');
