			...
			<div class="box box-default">
				<div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						...
						<a href="<?=site_url('admin/master/kategori/tambah_kategori')?>"  class="btn btn-box-tool" data-toggle="tooltip" title="Tambah">
          ...
          <div class="row">
            <div class="col-xs-12">
                <div class="form-group">
                    <input class="form-control" type="text" name="cari" placeholder="Cari Kategori ..">
                </div>
            </div>
          </div>
        </div>
				<div class="box-body no-padding">
					<div class="table-responsive">
						<table class="table table-striped table-hover tabel_kategori" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th width="5%">No</th>
                  <th >Kategori</th>
