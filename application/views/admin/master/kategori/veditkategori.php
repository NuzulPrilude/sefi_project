...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Edit Katagori</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="box box-default">
				...
				<form action="<?=site_url('admin/master/kategori/editkategori/'.@$id_kategori_barang)?>" method="post" class="form-wajib">
					<div class="box-body">

						<div class="form-group">
							<label>Nama Kategori</label>
							<div>
								<input type="text" class="form-control" value="<?=$data_kategori->kategori?>" name="kategori" placeholder="Kategori">
							</div>
						</div>
...
var url_2 = url_1.substring(0, url_1.lastIndexOf('/editkategori/'));
var fw = $('.form-wajib');
