...
class Mod_all extends CI_Model
{
    ...
    public function mencari_where_in($tabel, $field, $where)
    {
        if ($where != null) {
    ...
    public function mengambilFunction($tabel, $where = null)
    {
        if ($where != null) {
            $where;
        }
...
/* End of file Mod_all.php */
/* Location: ./application/models/Mod_all.php */
